...
import { X, Coffee, MapPin, Gift, Calendar, Hash, Truck, CheckCircle2 } from 'lucide-react';
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-6">
          ...
          <motion.div 
            ...
            className="bg-white dark:bg-[#1A0A0A] w-full max-w-2xl rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl relative z-10 flex flex-col max-h-[85vh]"
          >
            {/* Header */}
            ...
            <div className="flex-1 overflow-y-auto p-8 custom-scrollbar space-y-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-6 rounded-3xl bg-[#FDFCF8] dark:bg-white/5 border border-[#3E2723]/5">
              ...
              <div>
                ...
                <div className="space-y-4">
                  {order.items?.map((item, idx) => (
                    <div key={idx} className="flex items-center justify-between p-4 rounded-2xl bg-white dark:bg-white/5 border border-[#3E2723]/5 shadow-sm">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-stone-100 dark:bg-stone-900 overflow-hidden">
                          <img src={item.image} alt="" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" />
                        </div>
                        <div>
                      ...
                      <p className="text-sm font-inter font-bold text-[#3E2723] dark:text-white">${item.price}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="p-6 rounded-3xl bg-[#3E2723] text-white/90">
                  <p className="text-sm font-playfair mb-1">{order.first_name} {order.last_name}</p>
